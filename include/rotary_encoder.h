 ...
 *
 * As a UIController, the rotary encoder is associated with a ModelObject.
 *
 */
...
public:
  ...
  ~RotaryEncoder();
  /**
   * @brief the ISR that process the IRQ and send UIControlEvent to the  ModelObject currentControlledObject.
   *
