...
{
    tx_dma->write_dma2i2c(&fifo_empty,
                          this->i2c, slave_address, slave_mem_addr, this->i2c_master_handler,
                          src, len);
}

void rtos_HW_I2C_Master::i2c_tx_fifo_dma_isr()
{
    irq_num_t irq_number = (this->i2c == i2c0) ? I2C0_IRQ : I2C1_IRQ; // only I2C0_IRQ and I2C1_IRQ are valid
