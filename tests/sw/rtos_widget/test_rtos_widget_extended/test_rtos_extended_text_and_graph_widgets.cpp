...
// my_text_widget ST7735_title_widget = my_text_widget(&color_display, ST7735_title_config, ST7735_TEXT_CANVAS_FORMAT);
...
struct_ConfigTextWidget ST7735_values_config = {
    ...
    .widget_anchor_y = 64,
    .font = font_12x16};
my_text_widget ST7735_values_widget = my_text_widget(&color_display, ST7735_values_config, ST7735_TEXT_CANVAS_FORMAT, nullptr);
...
my_visu_widget ST7735_graph_widget = my_visu_widget(&color_display, ST7735_graph_config, ST7735_GRAPHICS_CANVAS_FORMAT, nullptr);
...
// ##################SSD1306 widgets##################################################################################################################################
//-------------SSD1306 title and value widgets-----

// my_text_widget SSD1306_title = my_text_widget(&left_display, SSD1306_title_config, SSD1306_CANVAS_FORMAT);
...
my_text_widget SSD1306_values_widget = my_text_widget(&left_display, SSD1306_values_config, SSD1306_CANVAS_FORMAT, nullptr);
...
my_visu_widget SSD1306_graph_widget = my_visu_widget(&right_display, SSD1306_graph_config, SSD1306_CANVAS_FORMAT, nullptr);
